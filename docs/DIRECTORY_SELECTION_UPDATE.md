...
Students no longer need to edit `gamry_HiPOZ.py` to analyze their data.
...
python gamry_HiPOZ.py --dates 20250815Mahboub

# Process multiple directories:
python gamry_HiPOZ.py --dates 20250813 20250814 20250815

# Headless mode with specific directory:
python gamry_HiPOZ.py --headless --dates 20250815Mahboub

# Run with specific config file:
python gamry_HiPOZ.py --config data/20250815/zAnalysis20250815.csv
```
...
1. Tell students: `python gamry_HiPOZ.py`
...
python gamry_HiPOZ.py --dates Student1_20250815 Student2_20250815 Student3_20250815
```
...
### Old Workflow
1. Open `gamry_HiPOZ.py` in text editor
2. Find `dates = [...]` line
...
```bash
python gamry_HiPOZ.py --config data/20250815Mahboub2026/zAnalysis.csv
```
